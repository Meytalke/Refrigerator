...
namespace Refrigerator_FinalProj.Backend.Model
{
    ...
    public class Banana : Fruit
    {
        ...
        public Banana(string name, double price, DateTime purchaseDay, int shelfLife, double weight, string size, string color, string[] vitamins, string taste, bool isRipe, bool hasSeeds)
        ...
        //{
        //    Console.WriteLine("Peeling an Banana...");
        //}
    }
}